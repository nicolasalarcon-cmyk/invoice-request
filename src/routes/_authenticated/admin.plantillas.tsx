...
export const Route = createFileRoute("/_authenticated/admin/plantillas")({
  component: PlantillasPage,
  head: () => ({ meta: [{ title: "Plantillas · Admin" }] }),
});
...
function PlantillasPage() {
  ...
  if (pathname.startsWith("/admin/plantillas/") && pathname.endsWith("/editor")) {
    return <Outlet />;
  }
                ...
                <div className="flex gap-2 shrink-0">
                  {t.id && (
                    <Button size="sm" asChild>
                      <Link to="/admin/plantillas/$id/editor" params={{ id: t.id }}>
