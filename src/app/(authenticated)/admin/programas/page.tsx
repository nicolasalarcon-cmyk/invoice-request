          ...
          {editing && (
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="sm:col-span-2">
                <FieldRow label="Nombre completo *"><Input value={editing.nombre} onChange={(e) => setEditing({ ...editing, nombre: e.target.value })} placeholder="Ej: Diplomado Finanzas con Inteligencia Artificial" /></FieldRow>
              </div>
              <FieldRow label="Nemónico"><Input value={editing.nemonico ?? ""} onChange={(e) => setEditing({ ...editing, nemonico: e.target.value.toUpperCase() })} placeholder="Ej: DFINIA" /></FieldRow>
