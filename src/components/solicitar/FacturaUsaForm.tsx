...
export function FacturaUsaForm({ editId, duplicateFromId }: { editId?: string; duplicateFromId?: string }) {
  ...
  // Checkbox "Valor parcial a pagar" (roles distintos de cartera): sobreescribe
  // el total final que se factura, sin tocar el cálculo normal que se muestra.
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = {
        ...
        recargo_total: Math.round((isJuridica ? finalTotalAbierta : finalTotalCerrada) * 1.1),
