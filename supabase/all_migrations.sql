...
-- Catalogo de asesores comerciales: quienes realmente atienden al cliente,
-- distinto de la cuenta "Comercial" (jefe de area) que crea la solicitud.
-- El jefe selecciona a que asesor corresponde cada solicitud al crearla.
...
-- ==================== 20260714150000_restringir_lectura_adjuntos ====================
...
-- ==================== 20260721160000_approved_pdf_name ====================
...
-- ============================================================
-- 20260725090000_consecutivo_factura_usa.sql
-- ============================================================
